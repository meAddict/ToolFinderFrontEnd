...
import EachToolView from "./tools/EachToolView";
    ...
    return <div>
            {
                ...
                <div className="my-auto bg-red-500">
                    <form className="m-auto grid align-between p-20" onSubmit={handleSearchSubmit}>
                        <div>
                            <label htmlFor="" className="text-lg/6 font-medium text-white">Search for tools</label>
                        </div>
                        <div className="my-5 grid align-between">
                            <label htmlFor="name" className="text-sm/6 font-medium text-white">Tool Name*</label>
                        ...
                        <div className="my-5 grid align-between">
                            <label htmlFor="pincode" className="text-sm/6 font-medium text-white">Location Pincode*</label>
                        ...
                        <div className="flex justify-between my-5">
                            <div></div>
                            <button type="submit" className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">Find Tools</button>
                        </div>
                    </form>
                </div> : 
                <div>
